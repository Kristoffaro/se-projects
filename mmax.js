...
var footer = '<div class="col col-sm-4" style="">' +
    '<ul class="list-unstyled"><li class="nav-item"><a href="/account/">Your Account</a>' +
    '</li><li class="nav-item"><a href="/register.html">Register</a></li><p><small>' +
    '&copy; 2019 MovieMax</small></p></ul></div><div class="col col-sm-4">' +
    '<ul class="list-unstyled"><li class="nav-item"><a href="/terms.html">Terms of Use</a>' +
    '</li><li class="nav-item"><a href="/privacy.html">Privacy Policy</a></li></ul></div>' +
    '<div class="col col-sm-4"><ul class="list-unstyled"><li class="nav-item">' +
    '<a href="/contact.html">Contact Us</a></li><li class="nav-item"><a href="/about.html">' +
...
var header_loggedIn = '<nav class="navbar navbar-expand-sm bg-dark navbar-dark">' +
    ...
    '<a class="dropdown-item" href="/account/stream.html">Movie library</a>'+
